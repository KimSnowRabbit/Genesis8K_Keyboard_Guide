# 필독 : 공유, 불펌하지 말아주세요. 작성자도 힘들게 작성한 부분입니다. (따로 이 github 링크를 통해서 공유하는건 가능합니다.)
...
따로 쓰톤님께서도 작성하시는데 도움을 많이 주셨습니다 감사합니다 :)
...
![347767118-de74a5ea-7340-4e19-ae3c-8c136faf2864.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347767118-de74a5ea-7340-4e19-ae3c-8c136faf2864.png)
...
![1.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/1.png)

여기서 키보드 그림의 오른쪽에 **> 모양**을 눌러주게 되면 날개가 펴지듯이 여러 정보들의 창이 출력이 됩니다.

![2.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/2.png)
...
![3.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/3.png)

매니저 메뉴를 클릭하고 **키 매핑**을 클릭해줍니다.

![4.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/4.png)

그러면 이렇게 **큰 이미지**가 하나 뜨게 될건데, 차근차근 하나씩 설명 드리겠습니다.
진짜 하나씩 뜯어보면 쉽습니다. 빠르게 알려드리겠습니다.

![5.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/5.png)
...
![6.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/6.png)

우선 Map1 또는 2를 불러오기 전에 키보드 레이아웃키를 눌러, **자신의 배열의 맞는 친구**로 설정해줍니다.

+ 2024.07.12 21:17:00 추가내용

![6_1.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/6_1.png)

레이아웃키를 우클릭으로 누르면 리스트 모양으로 나오면서 **자신의 배열에 맞는 친구로 간편하게 설정**이 가능합니다.
...
![7.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/7.png)

**키보드 맵 1 or 2**를 눌러서 정보를 가져와줍니다.

![8.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/8.png)
...
![9.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/9.png)

우선 이 상태에서, **키보드 키 레이어**를 클릭합니다.

![10.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/10.png)

이런식으로 창이 나오게 되는데, 이제 이 창에서 **변경**이 가능합니다.

![11.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/11.png)
...
![12.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/12.png)

자 어때요, 설정이 끝났습니다. **정말 쉽죠?**

![zLNFIBtisESk634049407784855842.jpg](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/zLNFIBtisESk634049407784855842.jpg)

자 이젠 테스트를 해봐야겠죠? 한번 **저장을 하고 테스트를 해보러 가봅시다.**

![13.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/13.png)
...
![no.webp](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/no.webp)

알아서 다시 처음부터 하시면 됩니다 ^^..

![14.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/14.png)

Apply를 누르게 되면 막 상단 중앙에 주루룩 하면서 저장을 하게되고, 이런식으로 **메모리에 저장**을 하게 되었다는 말이 올라오게 됩니다.
이제 확인을 누르시고, 이 창을 꺼주시면 됩니다.

![15.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/15.png)

이제 다시 프로그램으로 돌아오시고, **키보드 키 맵 메뉴에, 따로 키 매핑을 설정해준 Key Map1 or 2**로 클릭해주시기만 하면 적용이 됩니다. **간단하죠?**

![image-20240712102803499.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/image-20240712102803499.png)
...
![16.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/16.png)

설정 방식은 아래에 있는 8K 100% 파워 스피드 버튼을 바꿔서 **N-Key RollOver Process Time Mode**로 바꿔주시면 됩니다.

그러면 약간 핑크무늬가 나오게 될 것이고, 설정 1단계는 완료 되었습니다.

다만 사장님의 말씀으로 꾹보드의 기능은,

> 8000Hz 폴링레이트로 동작은 하지만 8K 100% 성능은 조금 희생 됩니다.

라고 하셨으니, 인지 하시길 바라겠습니다.

![17.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/17.png)
...
![18.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/18.png)
...
![347769275-d545d667-e13d-450c-9c7f-37b7e03aa599.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347769275-d545d667-e13d-450c-9c7f-37b7e03aa599.png)
...
예를 들어보자면 사진처럼 저는 Down 0.3, Up 0.1 을 사용 중입니다. 만일 " **나는 입력지점은 좀 얕지만, 레피드 트리거가 켜지는 깊이는 좀 깊게 하고 싶다** " 라고 한다면, ON 0.6 이런 식으로 사용하시면 됩니다. 

OFF의 경우에는 그 반대입니다. 설명서에는 OFF 되는 거리 정도로 적혀 있는데,  ON과 UP의 값보다 **크지 않게** 만 설정해주시면 될 것 같습니다. 
*OFF를 깊게 설정을 해서 써봤는데, 손이 미세하게 떨려서 그런 것인지, 그 미묘한 차이를 잘 잡아내지 못했습니다.*
...
![347773561-44bf6095-948a-4ab2-b703-ddebca3da0e4.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347773561-44bf6095-948a-4ab2-b703-ddebca3da0e4.png)
...
![347773718-ca8111b8-4e14-49c8-bbf7-0d3752eefd35.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347773718-ca8111b8-4e14-49c8-bbf7-0d3752eefd35.png)

매니저 창에서 **Manager** 을 선택한 이후 **Hall Effect Opne** 이라는 창을 실행하게 되면 아래와 같은 창이 뜨게 됩니다.

![347774010-1d65866e-9970-40fc-94fd-36ec9cc8860f.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347774010-1d65866e-9970-40fc-94fd-36ec9cc8860f.png)

해당 창에서 왼쪽 위에 있는 파란색 버튼( **Keyboard HE Switch Load** )를 선택해주면 초기에 세팅되어 있는 값들이 출력이 됩니다.

![347775683-e9d0730b-715c-4619-bc76-06143eb9304b.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347775683-e9d0730b-715c-4619-bc76-06143eb9304b.png)
...
![select.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/select.png)
...
![347784845-168db31c-c695-4358-ac48-3f2870b66fe5.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347784845-168db31c-c695-4358-ac48-3f2870b66fe5.png)

![347784774-e106563c-e4e7-422f-a491-9e83dcb96f29.png](https://github.com/KimSnowRabbit/Genesis8K_Keyboard_Guide/blob/main/img/347784774-e106563c-e4e7-422f-a491-9e83dcb96f29.png)
